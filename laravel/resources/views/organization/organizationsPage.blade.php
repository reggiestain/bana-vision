...
<div class="card card-custom d-flex mt-2 institution" > 
  <div class="card-header">
    <h5>
      <i class="fas fa-hand-holding-heart" style="color: #8b4513"></i>
      <span class="ml-1">
        Organizations
    </span>
    </h5>
    ...
    <organizations-page ref="organizationspage" v-bind:post="{{$organizations}}" v-bind:shared="false"></organizations-page>
