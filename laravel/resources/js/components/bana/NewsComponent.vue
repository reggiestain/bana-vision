...
<div>
   ...
   <!--===========================LOADING SPINNER===========================-->
	...
	<div v-if="!searchloading" v-for="(chunk,chunkIndex) in chunkedPosts" :id="news_id(chunk.id)">
  ...
  <div class="card-header">
    ...
    <!--============================EVENT MORE OPTIONS DROPDOWN========================================-->
     <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
        ...
        <a class="dropdown-item" href="route('deleteEvent',['eventIdNo'=>$post->id])" style="color:red">
        ...
        <a class="dropdown-item" href="route('ourEventsPage',['user'=>$post->user])">more events from $post->user->name</a>
        @endif
    ...
    <div class="card-body" style="padding: 0"> 
      ...
      <div class="col-3 p-3" style="    text-align: center;">
        <span class="fa-stack fa-3x">
          <i class="fas fa-rss-square fa-stack-2x" style="color:#4169e1"></i>
        </span>
      </div>
      <!--==============================EVENT DETAILS==============================-->
...
<script>
	...
	export default 
	{
		props:['post','shared','isRouteOurEventsPage','isEvent','auth_id','previousComponent'],
		data: function() {
	 		return {
	...
	methods:
	{
		getEventPic:function(filename,pic_index)
		{
			var flnm;
      		...
      		return '/post-picture/'+flnm+'/events';
		},
