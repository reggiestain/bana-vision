<template>
	<div role="tabcard" class="tab-pane" id="sponsored-users">
		<nav>
			<div class="card-header nav nav-tabs p-0 border-bottom" id="nav-tab" role="tablist">
				<div class="pb-0 p-3  col-12" >
					...
					<div class="dropdown-menu" aria-labelledby="activities-dropdown" v-if="auth_id == user._id">
		...
		<div class="tab-content card-body p-0" id="nav-tabContent">
			<div class="tab-content card-body p-0" id="nav">
				<div class="tab-pane fade show active col-12 p-2 container" id="school-activities" role="tabpanel" aria-labelledby="cover-photos-tab" >
								...
								<header>
									<div class="travel-type-wrap">
										...
										<div class="item">
											...
											<span>PROVINCE + CITY + SURBURB</span>
										</div>
										<div class="item">
											<div class="group-icon">
								...
								<div class="main-form" id="main-form">
									<div class="row">
										<div class="input-wrap">
											...
											<div class="input-field">
												...
												<input type="text" placeholder="Enter province name" />
											</div>
										</div>
									</div>
									<div class="row second">
										<div class="input-wrap">
											...
											<div class="input-field">
												<label>Criteria A</label>
												<input class="datepicker" type="text" placeholder="criteria a" />
											</div>
										</div>
										<div class="input-wrap">
											<div class="icon-wrap">
											...
											<div class="input-field">
												<label>Criteria B</label>
												<input class="datepicker" type="text" placeholder="criteria b" />
											</div>
										</div>
										<div class="input-wrap">
											<div class="icon-wrap">
					...
					<!-- ========================== USERS -->
					<div class="container-fluid mt-2" v-for="n in 3">
					<!--first loop-->
					<div class="row m-0">
						<!-- second loop -->
						<div class="col-4" v-for="n in 3">
							<figure class="figure">
								<img src="/assets/img/about.png" class="figure-img img-fluid rounded-circle show-photo" alt="A generic square placeholder image with rounded corners in a figure." style="max-width: 100%;width: 6rem;object-fit: cover;border-radius:50%;width: 50px;height: 50px;">

								<figcaption class="figure-caption">student {{n}} name</figcaption>
							</figure>
						</div><!-- end second loop -->
