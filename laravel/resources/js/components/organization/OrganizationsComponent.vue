     ...
     <!--IF POST IS SHARED-->
            ...
            <div class="media d-flex align-items-center p-0">
              ...
              <div class="media-body" >
                ...
                <a style="color: black" >
                 {{chunk.organization_type}} Organization
               </a>
             </div>
             <!--***************************BURSARY MORE OPTIONS BUTTON******************************-->
      ...
      <div class="col-3 p-3" style="    text-align: center;">
        <span class="fa-stack fa-3x">
          <i class="fas fa-hands fa-stack-2x" style="color:#4169e1"></i>
        </span>
      </div>
      ...
      <div class="col-9 p-3" id="container-$post->id">
          <ul class="list-group ml-3">
            <li class="list-group-item" style="border: none;padding:0.25rem">
             ...
             <li class="list-group-item" style="border: none;padding:0.25rem">
              <strong>
                <i class="fas fa-check-double" style="color:#adff2f"></i>
                <span class="ml-2">
                  Focus : {{chunk.focus}}
              </span>
            </strong>
             ...
             <li class="list-group-item" style="border: none;padding:0.25rem">
              <strong>
                ...
                <span class="ml-2">
                  Address : 
                  <address>
                    {{chunk.headquarters_address}} 
                    <br> {{chunk.headquarters_town}}
                    <br>
                    {{chunk.headquarters_area_code}}
                  </address>
             </span>
             </strong>
