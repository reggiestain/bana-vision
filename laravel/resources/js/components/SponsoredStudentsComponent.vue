...
<div class = "container dashboard mt-4">
      ...
      <div class="col-md-6 col-sm-6 col-12">
         <div class="info-box bg-info">
            ...
            <div class="info-box-content">
               ...
               <span class="info-box-number">313</span>
               <div class="progress">
                  <div class="progress-bar" style="width: 13%"></div>
               </div>
               <span class="progress-description">
               13.5% Increase in Schools
               </span>
            </div>
            <!-- /.info-box-content -->
         </div>
      ...
      <div class="col-md-6 col-sm-6 col-12">
         <div class="info-box bg-info">
            ...
            <div class="info-box-content">
               ...
               <span class="info-box-number">31,450</span>
               <div class="progress">
                  <div class="progress-bar" style="width: 40%"></div>
               </div>
               <span class="progress-description">
               40% Increase in Growth
               </span>
            </div>
            <!-- /.info-box-content -->
         </div>
   ...
   <div class="row">
      <div class="col-md-6">
         ...
         <div class="card card-widget widget-user">
            ...
            <div class="widget-user-header bg-info">
               <h3 class="widget-user-username">Ntando Bhutiza</h3>
               <h5 class="widget-user-desc">Student (Leader)</h5>
            </div>
            <div class="widget-user-image">
               <img class="img-circle elevation-2" src="/assets/img/profile.png" alt="User Avatar">
            </div>
            <div class="card-footer">
               <div class="row">
                  <div class=" col-md-4 col-xs-4 col-lg-4 col-sm-4 border-right">
      ...
      <div class="col-md-6">
         ...
         <div class="card card-widget widget-user">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header bg-info">
               <h3 class="widget-user-username">Andre Moloto</h3>
            ...
            <div class="card-footer">
               <div class="row">
                  ...
                  <div class="col-sm-4 border-right">
                     <div class="description-block">
                        <h5 class="description-header">101</h5>
                        <span class="description-text">Followers</span>
                     </div>
                    <!-- /.description-block -->
                  </div>
      ...
      <div class="col-md-6">
         ...
         <div class="card card-widget widget-user">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header bg-info">
               <h3 class="widget-user-username">Natasha Beyers</h3>
               <h5 class="widget-user-desc">Student</h5>
            </div>
            <div class="widget-user-image">
               <img class="img-circle elevation-2" src="/assets/img/profile.png" alt="User Avatar">
            ...
            <div class="card-footer">
               <div class="row">
                  ...
                  <div class="col-sm-4 border-right">
                     <div class="description-block">
                        <h5 class="description-header">1201</h5>
                        <span class="description-text">Followers</span>
                     </div>
                     <!-- /.description-block -->
                  </div>
   ...
   <div class="row">
      ...
      <div class="col-md-4" >
         <!-- DIRECT CHAT PRIMARY -->
         <div class="card  card-outline direct-chat direct-chat-primary size-up">
            <div class="card-header">
               ...
               <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                     <div class="direct-chat-infos clearfix">
                        <span class="direct-chat-name float-left">Organization NGO</span>
                        <span class="direct-chat-timestamp float-right">23 Jan 2:00 pm</span>
                     </div>
                     <!-- /.direct-chat-infos -->
                     <img class="direct-chat-img" src="/assets/img/profile.png" alt="Message User Image">
                     <!-- /.direct-chat-img -->
                     <div class="direct-chat-text">
                        Dear Ntando you have been selected for our Bursary
                     </div>
                     <!-- /.direct-chat-text -->
                  </div>
                  <!-- /.direct-chat-msg -->
                  ...
                  <div class="direct-chat-msg right">
                     <div class="direct-chat-infos clearfix">
                        <span class="direct-chat-name float-right">Ntando Bhutiza</span>
            ...
            <div class="card-footer">
               <form action="#" method="post">
                  <div class="input-group">
                     ...
                     <button type="submit" class="btn text-white bg-info">Send</button>
                     </span>
                  </div>
               </form>
            </div>
      ...
      <div class="col-md-4 ">
         <!-- Profile Image -->
         <div class="card card-secondary card-outline size-up">
            <div class="card-body box-profile">
               ...
               <h3 class="profile-username text-center">Ntando Bhutiza</h3>
               <p class="text-muted text-center">Student (Leader)</p>
               <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                     <b>Followers</b> <a class="float-right">121</a>
                  </li>
                  <li class="list-group-item">
                     <b>Following</b> <a class="float-right">548</a>
                  </li>
                  <li class="list-group-item">
                     <b>Projects</b> <a class="float-right">4</a>
                  </li>
               </ul>
               <a href="#" class="btn text-white btn-block bg-info"><b>Follow</b></a>
            </div>
            <!-- /.card-body -->
         </div>
         <!-- /.card -->
...
<script>
  ...
  var bar_data = {
    ...
    $.plot('#bar-chart', [bar_data], {
      ...
      colors: ['#3c8dbc'],
      xaxis : {
        ticks: [[1,'Gauteng'], [2,'Mpumalanga'], [3,'North West'], [4,'Limpopo'], [5,'Free state'], [6,'Western Cape']]
      }
    })
  ...
  function labelFormatter(label, series) {
	...
	export default
	{
        ...
        picked:'all',
				...
				locations:[],
				location:'',
        coeducational:'all',//gender
        funding:'all',
        k_12:'all',
        special_needs:'all',
        curriculumn_type:'all',
        facilities:[],
        facility:'',
        activity:'',
        activities:'',
		...
		/*	//
			...
			{
        filter.onInputChange(event,this,'schools',this.locations,this.picked,this.location,'schools',true);
      },
      //
      onChangeCoeducational:function(event)
      {
        filter.onInputChange(event,this,'schools',null,'coeducational',event.target.value,'schoolspage');
      },
      //
      onChangeFunding:function(event)
      {
        filter.onInputChange(event,this,'schools',null,'funding',event.target.value,'schoolspage');
      },
      //
      onChangeK12:function(event)
      {
        filter.onInputChange(event,this,'schools',null,'k_12',event.target.value,'schoolspage');
      },
      //
      onChangeSpecialNeeds:function(event)
      {
        filter.onInputChange(event,this,'schools',null,'special_needs',event.target.value,'schoolspage');
      },
			
                    //
      onChangeCurriculumnType:function(event)
      {
        filter.onInputChange(event,this,'schools',null,'curriculumn_type',event.target.value,'schoolspage');
      },
                  //
      onChangeFacility:function(event)
      {
        filter.onInputChange(event,this,'schools',this.facilities,'facility',this.facility,'schoolspage');

      },
      //
      onChangeActivity:function(event)
      {
        filter.onInputChange(event,this,'schools',this.activities,'activity',this.activity,'schoolspage');

      },
      //
			onChangeSchoolName:function(event)
			{
        filter.onInputChange(event,this,'schools',this.school_names,'school_name',this.school_name,'schoolspage');
      },*/
		},
		computed:
		{
