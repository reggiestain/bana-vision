    ...
    <div class="card card-default" id="card_contacts">
        <div id="contacts" class="panel-collapse collapse show" aria-expanded="true" style="">
            <ul class="list-group pull-down" id="contact-list">
                ...
                <li v-for="contact in contactlist" class="list-group-item">
                    <div class="row w-100">
                        <div class="col-12 col-sm-6 col-md-3 px-0">
                            <img :src="contactImage(contact.id)" alt="Debbie Schmidt" class="img-fluid rounded-circle d-block mx-auto" style="object-fit: cover;border-radius:50%;width: 50px;height: 50px;">
                        </div>
                        <div class="col-12 col-sm-6 col-md-9 text-center text-sm-left">
                            <label class="name lead">{{contact.name}} {{contact.surname}}</label>
                            <br>
...
<script>
	export default
	{
		...
		methods:
		{
			contactImage:function(user_id){
				return './school-picture/'+user_id;
			}
		}
