            ...
            <div class="project-box" style="background-color: #fee4cb;">
              ...
              <div class="box-progress-wrapper">
                ...
                <div class="box-progress-bar">
                  <span
                    class="box-progress"
                    style="width: 60%; background-color: #df3670"
                  ></span>
                </div>
            ...
            <div class="project-box" style="background-color: #e9e7fd;">
              ...
              <div class="box-progress-wrapper">
                ...
                <div class="box-progress-bar">
                  <span
                    class="box-progress"
                    style="width: 50%; background-color: #df3670"
                  ></span>
                </div>
            ...
            <div class="project-box">
              ...
              <div class="box-progress-wrapper">
                ...
                <div class="box-progress-bar">
                  <span
                    class="box-progress"
                    style="width: 80%; background-color: #df3670"
                  ></span>
                </div>
            ...
            <div class="project-box" style="background-color: #ffd3e2">
              ...
              <div class="box-progress-wrapper">
                ...
                <div class="box-progress-bar">
                  <span
                    class="box-progress"
                    style="width: 40%; background-color: #df3670"
                  ></span>
                </div>
